    ...
    this.storage.get("wordType").then(val => {
      ...
      storage.get("studentObject").then(val => {
        ...
        this.storage.get("methodIndex").then(val => {
          ...
          this.sessionArray = this.studentObject.studentWordDetailsArray[
            this.wordType
          ].methodArray[this.methodIndex].sessionsArray;
          this.methodName = this.studentObject.studentWordDetailsArray[
            this.wordType
          ...
          for (let sessionObj of this.sessionArray) {
            ...
            for (let preSessionObj of this.preSessionWordDataArray) {
              if (preSessionObj.isKnownWord) counter++;
            }
