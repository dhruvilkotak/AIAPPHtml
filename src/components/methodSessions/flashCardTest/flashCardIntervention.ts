...
export class FlashCardIntervetion {
  ...
  greenCircleClick() {
    ...
    this.methodInterventionWordDataObj = this.getMethodSessionWordDataObject(
      this.wordDataObject
    );
  ...
  updateMethodSessionWordDataObject(
    ...
    for (let obj of this.methodInetrventionWordDataArray) {
      if (
        obj.wordData.wordId == methodInterventionWordDataObj.wordData.wordId
      ) {
        this.methodInetrventionWordDataArray[
          this.methodInetrventionWordDataArray.indexOf(obj)
