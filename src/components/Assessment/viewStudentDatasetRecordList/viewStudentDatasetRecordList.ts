...
export class ViewStudentDatasetRecordList {
  ...
  wordType: number = 0;
  selectedDatasetList: Array<StudentDataSetRecord> = [new StudentDataSetRecord()];
  restrictedDatasetList: Array<StudentDataSetRecord> = [new StudentDataSetRecord()];
  notConvertedcompletedDatasetList: Array<StudentDataSetRecord> = [new StudentDataSetRecord()];
