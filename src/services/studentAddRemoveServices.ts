...
export class StudentServices {
      ...
      file
        ...
        .then(_ => {
          ...
          file
            ...
            .catch(err => {
              console.log(
                "read unsecc student array:" + studentDetailsArray.length
              );
              reject(studentDetailsArray);
            });
        })
        .catch(err => {
          console.log(
            "file not exist student array:" + studentDetailsArray.length
          );
          reject(studentDetailsArray);
        });
    });
  ...
  removeStudentFromArray(
    studentDetailsArray: Array<StudentData>,
  ...
  updateStudentToArrayExist(
    studentDetailsArray: Array<Student>,
  ...
  importStudentFile(
    ...
    studentServicesObject: StudentServices,
    StudentDetailsArray: Array<Student>
  ): Promise<any> {
    return new Promise(function(resolve, reject) {
      var fileData: any;
                    ...
                    studentServicesObject
                      ...
                      .then(data => {
                        ...
                        for (let studentFileObj of studentFileArray) {
                          ...
                          var exist = this.checkStudentExist(
                            studentDetailsArray,
                            studentFileObj
                          );
                          if (!exist) {
