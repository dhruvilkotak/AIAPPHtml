...
export class StudentServices {
    ...
    removeStudentFromArray(studentDetailsArray: Array<StudentData> , studentObj:StudentData )
    {
    ...
    {
        studentDetailsArray.forEach(function(student, i) { if (student.studentData.studentId == studentObject.studentData.studentId) studentDetailsArray[i] = studentObject; });   
    }
