...
export class WordServices {
      ...
      file
        ...
        .then(_ => {
          ...
          file
            ...
            .catch(err => {
              console.log(
                "read unsecc WordData array:" + wordDetailsArray.length
              );
        ...
        .catch(err => {
          console.log(
            "file not exist WordData array:" + wordDetailsArray.length
          );
          reject(wordDetailsArray);
        });
    });
  ...
  addWordtoFile(
    file: File,
    wordDataObj: WordData,
    wordServiceObject: WordServices
  ): Promise<any> {
    return new Promise(function(resolve, reject) {
      var fileData: any;
      var wordDetailsArray: Array<WordData> = [];
        ...
        .then(wordDetailsArray => {
          ...
          if (wordDetailsArray.length > 0) {
            ...
            if (exist) {
              ...
              console.log(
                "Number of WordData added size:" + wordDetailsArray.length
              );
              ...
              file
                .writeFile(
                  file.dataDirectory,
                  "WordDetails",
                  JSON.stringify({ wordDetailsArray: wordDetailsArray }),
                  { replace: true }
                )
                .then(_ => {
  ...
  removeWordFromFile(
    file: File,
    wordDetailsArray: Array<WordData>
  ): Promise<any> {
    return new Promise(function(resolve, reject) {
      file
        .writeFile(
  ...
  removeKnownUnKnownWordFromArray(
    wordDetailsArray: Array<KnownUnknownWordData>,
    wordObj: WordData
  ) {
    var remove: boolean = false;
  ...
  removeArrayFromArray(
    wordArray: Array<WordData>,
    subWordArray: Array<WordData>
  ) {
          ...
          .then(uri => {
            ...
            file
              ...
              .then(result => {
                ...
                console.log(
                  "alllines:" + allLines.length + "  0:" + allLines[0]
                );
                ...
                while (c1 < allLines.length) {
                  ...
                  if (wordArray.length > 1) {
                    ...
                    if (exist) {
                      var error =
                        "WordData already exist with : " + wordObj.wordText;
                      console.log("" + error);
                    } else {
