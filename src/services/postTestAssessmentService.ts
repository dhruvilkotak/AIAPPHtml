...
export class PostTestAssessmentService {
  ...
  getPostTestWordDataArrayFromWordData(
    wordDataArray: Array<KnownUnknownWordData>
  ) {
  ...
  addPostTestWordDataRecordListObject(
    studentObject: Student,
    testIndex: number
  ) {}

  updateKnownUnknownWordData(
    studentObject: Student,
    wordDataArray: Array<PostTestWordData>
  ) {
    console.log("update counter:");
    for (let wordDataObj of wordDataArray) {
      this.incrementPostAssessmentCounter(studentObject, wordDataObj);
      for (let studentWordObj of studentObject.studentWordDetailsArray[
        this.wordType
  ...
  incrementPostAssessmentCounter(
    studentObject: Student,
    wordDataObject: PostTestWordData
  ) {}
}
