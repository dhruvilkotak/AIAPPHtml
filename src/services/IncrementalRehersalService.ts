...
export class IncrementalRehersalService {
  ...
  startSessionTest(
    methodSessionObject: MethodSession,
    ratio1: number,
    ratio2: number
  ) {
    if (ratio1 == null) ratio1 = 7;
    if (ratio2 == null) ratio2 = 4;
    ...
    var methodInetrventionWordDataArray: Array<MethodInterventionWordData> =
      methodSessionObject.sessionWordDataList;
    ...
    for (let unknownWordObj of unknownWordList) {
      ...
      while (i < ratio1) {
        ...
        this.updateWordDataToMethodIntevention(
          unknownWordObj,
          methodInetrventionWordDataArray,
          false
        );
  ...
  compareAssessment(
    uk1Map: MyMap,
    uk2Map: MyMap,
    preSessionWordDataArray: Array<PreSessionResultTest>
  ) {
    ...
    for (let wordDatauk1Obj of uk1Map.keys) {
      if (!this.myMapServiceObject.has(uk2Map, wordDatauk1Obj)) {
        ...
        preSessionWordDataObj.test1Known = this.myMapServiceObject.getValue(
          uk1Map,
          wordDatauk1Obj
        );
        ...
        if (
          this.myMapServiceObject.getValue(uk1Map, wordDatauk1Obj) ==
          ...
          preSessionWordDataObj.test2Known = this.myMapServiceObject.getValue(
            uk2Map,
            wordDatauk1Obj
          );
          preSessionWordDataObj.notes = "Keeping in Unknown list";
  ...
  getMethodSessionWordDataObject(
    wordDataObject: WordData,
  ...
  updateWordDataToMethodIntevention(
    wordDataObject: WordData,
    methodInetrventionWordDataArray: Array<MethodInterventionWordData>,
    isKnown: boolean
  ) {
    var methodInterventionWordDataObj: MethodInterventionWordData = this.getMethodSessionWordDataObject(
      wordDataObject,
      methodInetrventionWordDataArray
    );
