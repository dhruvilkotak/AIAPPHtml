...
export class StudentWordDetails{
    ...
    methodArray:Array<Method> = [new Method("Incremental Rehearsal",0),new Method("Direct Instruction",1),new Method("Traditional Drill & Practice",2),new Method("Control Intervention",3)];//store 3 methods
