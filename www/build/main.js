...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__services_DirectInstructionSevice__ = __webpack_require__(1246);
...
var PreSessionFlashCard = /** @class */ (function () {
    ...
    PreSessionFlashCard = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-blueflashcard',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\htmlpages\blueflashcard\blueflashcard.html"*/'<ion-header>\n  <ion-navbar>\n    <!-- <ion-title>{{TestTitle}} : {{currentCardNumber}}/{{totalCardNumber}}</ion-title> -->\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid style="height: 50%;padding-top: 10%;" *ngIf="result.length != 2">\n    <ion-row justify-content-center align-items-center style="height: 100%">\n      <h3 style="font-size: 150px;"> {{wordDataObject.wordText}} </h3>\n    </ion-row>\n  </ion-grid>\n\n  <ion-grid style="height: 50%;padding-top: 10%;width:40%;" *ngIf="result.length == 2">\n    <ion-row justify-content-center align-items-center style="float: right">\n      <ion-col></ion-col>\n      <ion-col>\n        <h3 style="font-size: 80px;"> {{number1}} </h3>\n      </ion-col>\n    </ion-row>\n    <ion-row justify-content-center align-items-center style="float: right">\n      <ion-col>\n        <h3 style="font-size: 80px;"> {{operation}} </h3>\n      </ion-col>\n      <ion-col>\n        <h3 style="font-size: 80px;"> {{number2}} </h3>\n      </ion-col>\n    </ion-row>\n    <ion-row style="float: right">\n      <div class="horizontal-black-line"></div>\n    </ion-row>\n    <ion-row *ngIf="showAnswer" justify-content-center align-items-center style="float: right">\n      <ion-col></ion-col>\n      <ion-col>\n        <h3 style="font-size: 80px;"> {{getAnswer(wordDataObject.wordText)}} </h3>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n</ion-content>\n\n<ion-content padding>\n  <ion-grid style="padding-top: 40%;">\n    <ion-row justify-content-center align-items-center style="height: 100%">\n      <ion-col class="center-col-item" style="max-width: 30%;">\n        <div class="img-circular-blue" (click)="greenCircleClick()">\n          <div class="horizontal-line"></div>\n        </div>\n      </ion-col>\n      <ion-col class="center-col-item" style="max-width: 30%;">\n        <div class="img-circular-blue" (click)="redCircleClick()">\n          <div class="verticle-line"></div>\n        </div>\n      </ion-col>\n    </ion-row>\n  </ion-grid>\n\n  <ion-grid style="height: 10%;padding-top: 10%;">\n    <ion-row justify-content-center align-items-right style="height: 100%">\n      <ion-icon name="volume-up" style="height: 20%;top: 20%;right: 20%;position: absolute;font-size: xx-large;"\n        (click)="textToSpeechWordData(wordDataObject.wordText)"></ion-icon>\n    </ion-row>\n  </ion-grid>\n\n  <ion-grid style="height: 10%;padding-top: 10%;" *ngIf="wordType == 1">\n    <ion-row justify-content-center align-items-right style="height: 100%">\n      <ion-icon name="sync" style="height: 20%;top: 20%;left: 20%;position: absolute;font-size: xx-large;"\n        (click)="flipCard()"></ion-icon>\n    </ion-row>\n  </ion-grid>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\htmlpages\blueflashcard\blueflashcard.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__ionic_native_file__["a" /* File */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavParams */],
...
var PreSessionAssessmentView = /** @class */ (function () {
    ...
    PreSessionAssessmentView = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-preSessionAssessmentView',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\methodSessions\preSessionAssessment\preSessionAssessmentView\preSessionAssessmentView.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Pre-Session View : Session {{sessionCounter+1}}</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding="\'true\'" scroll="false" class="has-header">\n  <ion-grid style="height: 20%">\n    <ion-row justify-content-center align-items-center style="height: 100%">\n      <h3> {{studentObject.studentData.firstName}} {{studentObject.studentData.lastName}} </h3>\n    </ion-row>\n  </ion-grid>\n\n  <div *ngIf="error" class="error-message">{{error}}</div>\n  <div col-sm-12 col-md-12 col-lg-12 col-xl-12 padding="\'true\'" scroll="false" class="has-header margin-auto">\n    <ion-card align-items-center>\n\n      <ion-item *ngIf="sessionCounter > 0 " align-items-center>\n        <ion-row class="ion-title" style="background-color: silver;">\n          <ion-col>Words</ion-col>\n          <ion-col *ngIf="sessionCounter > 1 "> Previous Test Result </ion-col>\n          <ion-col>Current Test result</ion-col>\n          <ion-col *ngIf="sessionCounter > 1 ">Notes:</ion-col>\n        </ion-row>\n\n        <ion-item *ngFor="let preSessionWordDataObj of preSessionWordDataArray">\n          <ion-row>\n            <ion-col>{{preSessionWordDataObj.wordData.wordText}}</ion-col>\n            <ion-col *ngIf="sessionCounter > 1 && preSessionWordDataObj.test1Known">Correct</ion-col>\n            <ion-col *ngIf="sessionCounter > 1 && !preSessionWordDataObj.test1Known">Incorrect</ion-col>\n            <ion-col *ngIf="preSessionWordDataObj.test2Known">Correct</ion-col>\n            <ion-col *ngIf="!preSessionWordDataObj.test2Known">Incorrect</ion-col>\n            <ion-col *ngIf="sessionCounter > 1 ">{{preSessionWordDataObj.notes}}</ion-col>\n          </ion-row>\n        </ion-item>\n      </ion-item>\n\n      <ion-item justify-content-center align-items-center>\n        <ion-row class="col col-center text-center">\n          <ion-col class="ion-title" style="background-color: silver;" align-items-center col-2>Unknown Words </ion-col>\n          <ion-col *ngFor="let wordDataObj of remainUnknownWordArray">\n            <ion-col align-items-center> {{wordDataObj.wordText}}</ion-col>\n          </ion-col>\n        </ion-row>\n        <br>\n        <ion-row *ngIf="methodIndex < 2 " class="col col-center text-center">\n          <ion-col class="ion-title" style="background-color: silver;" align-items-center col-2>Known Words </ion-col>\n          <ion-col *ngFor="let wordDataObj of methodSessionObject.knownWordList">\n            <ion-col align-items-center> {{wordDataObj.wordText}}</ion-col>\n          </ion-col>\n        </ion-row>\n      </ion-item>\n    </ion-card>\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\methodSessions\preSessionAssessment\preSessionAssessmentView\preSessionAssessmentView.html"*/
        }),
...
var PostAssessmentDashBoard = /** @class */ (function () {
    ...
    PostAssessmentDashBoard = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-PostAssessmentDashBoard',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\PostAssessment\postAssessmentDashBoard\PostAssessmentDashBoard.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Post Assessment</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid style="height: 10%">\n    <ion-row justify-content-center align-items-center style="height: 100%">\n      <h3> {{studentObject.studentData.firstName}} {{studentObject.studentData.lastName}} </h3>\n    </ion-row>\n  </ion-grid>\n  <div col-md-12 col-lg-12 col-xl-12 has-header="true" padding="true" ng-controller="AppCtrl as ctrl"\n    class="margin-auto">\n    <div style=" padding-top: 25%">\n      <div *ngIf="error" class="error-message">{{error}}</div>\n\n      <div class="row row-center">\n        <div class="col col-center">\n          <button ion-button (click)="startNewPostAssessment()" block> Start New Post Assessment </button>\n        </div>\n      </div>\n\n      <div class="row row-center">\n        <div class="col col-center">\n          <button ion-button (click)="viewPostAssessmentList()" block>View Post Assessment List</button>\n        </div>\n      </div>\n\n    </div>\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\PostAssessment\postAssessmentDashBoard\PostAssessmentDashBoard.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_2_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1__ionic_storage__["b" /* Storage */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavParams */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__services_postTestAssessmentService__ = __webpack_require__(1256);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_9__ionic_storage__ = __webpack_require__(10);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_10__ionic_native_text_to_speech__ = __webpack_require__(107);
...
var ViewStudent = /** @class */ (function () {
    ...
    ViewStudent = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-viewStudent',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\viewStudent\viewStudent.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>View Student</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid style="height: 10%">\n    <ion-row justify-content-center align-items-center style="height: 100%">\n      <h3> View Student : </h3>\n    </ion-row>\n  </ion-grid>\n\n\n  <div *ngIf="error" class="error-message">{{error}}</div>\n  <div padding="\'true\'" scroll="false" class="has-header margin-auto" col-md-12 col-lg-12 col-xl-12>\n    <ion-card>\n      <ion-searchbar [(ngModel)]="searchTerm" (ionInput)="filterItems()"></ion-searchbar>\n      <ion-grid style="height: 100%">\n        <ion-row justify-content-center align-items-center style="height: 100%">\n          <button ion-button class="submit-btn" full type="submit" (click)="exportStudentFile()">Export\n            Students</button>\n        </ion-row>\n      </ion-grid>\n\n      <!-- <ion-grid style="height: 100%">\n              <ion-row justify-content-center align-items-center style="height: 100%">\n                      <button ion-button class="submit-btn" full type="submit" (click)="importStudentFile()">Import Students</button>\n                </ion-row>\n            </ion-grid> -->\n\n      <ion-item>\n        <ion-row class="ion-title" style="background-color: silver;">\n          <ion-col>Student ID</ion-col>\n          <ion-col>Name</ion-col>\n          <ion-col></ion-col>\n        </ion-row>\n        <ion-item *ngFor="let studentObjects of studentDetailsArray">\n          <ion-row>\n            <ion-col (click)="viewStudentData(studentObjects)">{{studentObjects.studentId}}</ion-col>\n            <ion-col (click)="viewStudentData(studentObjects)">{{studentObjects.firstName}} {{studentObjects.lastName}}\n            </ion-col>\n            <ion-col>\n              <ion-item (click)="removeStudent(studentObjects)" style="color: blue">\n                Remove Student\n              </ion-item>\n            </ion-col>\n          </ion-row>\n        </ion-item>\n      </ion-item>\n    </ion-card>\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\viewStudent\viewStudent.html"*/
        }),
...
var ListPage = /** @class */ (function () {
    ...
    ListPage = ListPage_1 = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-list',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\pages\list\list.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>List</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content>\n  <ion-list col-md-12 col-lg-12 col-xl-12 class="margin-auto">\n    <button ion-item *ngFor="let item of items" (click)="itemTapped($event, item)">\n      <ion-icon [name]="item.icon" item-start></ion-icon>\n      {{item.title}}\n      <div class="item-note" item-end>\n        {{item.note}}\n      </div>\n    </button>\n  </ion-list>\n  <div *ngIf="selectedItem" padding>\n    You navigated here from <b>{{selectedItem.title}}</b>\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\pages\list\list.html"*/
        }),
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_common_http__ = __webpack_require__(592);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__components_viewWordList_viewWordList__ = __webpack_require__(591);
...
var MyApp = /** @class */ (function () {
    ...
    MyApp = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\app\app.html"*/'<ion-menu [content]="content">\n  <ion-header>\n    <ion-toolbar>\n      <ion-title>Menu</ion-title>\n    </ion-toolbar>\n  </ion-header>\n\n  <ion-content>\n    <ion-list>\n      <button menuClose ion-item *ngFor="let p of pages" (click)="openPage(p)">\n        {{p.title}}\n      </button>\n    </ion-list>\n  </ion-content>\n\n</ion-menu>\n\n<!-- Disable swipe-to-go-back because it\'s poor UX to combine STGB with side menus -->\n<ion-nav [root]="rootPage" #content swipeBackEnabled="false"></ion-nav>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\app\app.html"*/
        }),
        __metadata("design:paramtypes", [typeof (_b = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* Platform */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["j" /* Platform */]) === "function" && _b || Object, typeof (_c = typeof __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_2__ionic_native_status_bar__["a" /* StatusBar */]) === "function" && _c || Object, typeof (_d = typeof __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_3__ionic_native_splash_screen__["a" /* SplashScreen */]) === "function" && _d || Object, typeof (_e = typeof __WEBPACK_IMPORTED_MODULE_8__ionic_native_screen_orientation__["a" /* ScreenOrientation */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_8__ionic_native_screen_orientation__["a" /* ScreenOrientation */]) === "function" && _e || Object, typeof (_f = typeof __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["a" /* AlertController */]) === "function" && _f || Object, typeof (_g = typeof __WEBPACK_IMPORTED_MODULE_12__ionic_storage__["b" /* Storage */] !== "undefined" && __WEBPACK_IMPORTED_MODULE_12__ionic_storage__["b" /* Storage */]) === "function" && _g || Object])
    ], MyApp);
    return MyApp;
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0_mathjs__ = __webpack_require__(812);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__StudentWordDetails__ = __webpack_require__(804);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__addressFormat__ = __webpack_require__(803);
...
var AddWordList = /** @class */ (function () {
    ...
    AddWordList = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-addWordList',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\addWordList\addWordList.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle *ngIf="!fromModal ">\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Add Words/MathFacts</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid style="height: 10%">\n    <ion-row justify-content-center align-items-center style="height: 100%">\n      <h3> Add Word/MathFact Details : </h3>\n    </ion-row>\n  </ion-grid>\n\n\n  <div *ngIf="error" class="error-message">{{error}}</div>\n  <div col-md-12 col-lg-12 col-xl-12 padding="\'true\'" scroll="false" class="has-header margin-auto">\n    <ion-card>\n\n      <form class="list" #newStudentForm="ngForm" (ngSubmit)="addNewWord()">\n\n        <ion-row>\n          <ion-col>\n            <ion-list inset>\n\n              <ion-item>\n                <ion-label text-wrap>Word : </ion-label>\n                <ion-input name="wordText" required [(ngModel)]="wordText" type="text"></ion-input>\n              </ion-item>\n              <ion-item>\n                <ion-label text-wrap>Word Type : </ion-label>\n                <ion-label text-wrap *ngIf="isWord">Words</ion-label>\n                <ion-label text-wrap *ngIf="!isWord">Math Facts</ion-label>\n                <ion-toggle [(ngModel)]="isWord" (ionChange)="changeWordType()" [ngModelOptions]="{standalone: true}">\n                </ion-toggle>\n\n              </ion-item>\n              <ion-item (click)="selectCateory()" style="color: blue">\n                {{wordCategory}}\n              </ion-item>\n\n              <ion-grid style="height: 100%">\n                <ion-row justify-content-center align-items-center style="height: 100%">\n                  <button ion-button class="submit-btn" full type="submit" *ngIf="isWord"\n                    [disabled]="!newStudentForm.form.valid">Add Word\n                  </button>\n                  <button ion-button class="submit-btn" full type="submit" *ngIf="!isWord"\n                    [disabled]="!newStudentForm.form.valid">Add Math Fact\n                  </button>\n                </ion-row>\n              </ion-grid>\n            </ion-list>\n          </ion-col>\n        </ion-row>\n      </form>\n    </ion-card>\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\addWordList\addWordList.html"*/
        }),
...
var AdminHomePage = /** @class */ (function () {
    ...
    AdminHomePage = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-adminHomePage',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\home\adminHomePage\adminHomePage.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Admin</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <h3> Welcome : {{userDetails.firstname}} {{userDetails.lastname}} ,</h3>\n  <div col-md-12 col-lg-12 col-xl-12 has-header="true" padding="true" ng-controller="AppCtrl as ctrl"\n    class="margin-auto">\n    <div style=" padding-top: 25%">\n      <div class="row row-center">\n        <div class="col col-center">\n          <button ion-button (click)="addNewUserEmail()" block> Add New User Email </button>\n        </div>\n      </div>\n\n      <div class="row row-center">\n        <div class="col col-center">\n          <button ion-button (click)="updateRegisteredUser()" block>Update User Role</button>\n        </div>\n      </div>\n\n    </div>\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\home\adminHomePage\adminHomePage.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2__ionic_storage__["b" /* Storage */]])
...
var Login = /** @class */ (function () {
    ...
    Login = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-login',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\login\login.html"*/'<ion-header>\n  <ion-navbar>\n    <ion-title> Login </ion-title>\n  </ion-navbar>\n</ion-header>\n<ion-content>\n  <ion-card col-md-12 col-lg-12 col-xl-12 class="margin-auto">\n    <!-- \n          <ion-datetime displayFormat="MMM DD, YYYY HH:mm" [(ngModel)]="sessionDate"></ion-datetime> -->\n\n    <div *ngIf="error" class="alert alert-danger">{{error}}</div>\n    <form #loginForm="ngForm" (ngSubmit)="login()" autocomplete="off">\n      <ion-row>\n        <ion-col>\n          <ion-list inset>\n            <ion-item>\n              <ion-input placeholder="Email ID" name="emailID" id="loginField" type="text" required\n                [(ngModel)]="emailID" #email></ion-input>\n            </ion-item>\n            <ion-item>\n              <ion-input placeholder="Password" [type]="passwordType[0]" name="password" id="passwordField" required\n                [(ngModel)]="password"></ion-input>\n              <ion-icon item-end [name]="passwordIcon[0]" class="passwordIcon" (click)=\'hideShowPassword(0)\'></ion-icon>\n            </ion-item>\n          </ion-list>\n        </ion-col>\n      </ion-row>\n      <ion-row>\n        <ion-col>\n          <button ion-button class="submit-btn" full type="submit" [disabled]="!loginForm.form.valid">Login\n          </button>\n          <ion-item style="color: blue">\n            <ion-label text-wrap (click)="createOrganizationAccount()">Create Organization Account ! </ion-label>\n          </ion-item>\n          <ion-item style="color: blue">\n            <ion-label text-wrap (click)="signUpFaculty()">Sign Up as a Faculty ! </ion-label>\n          </ion-item>\n          <ion-item style="color: blue">\n            <ion-label text-wrap (click)="forgetPassword()">Forget Password </ion-label>\n          </ion-item>\n        </ion-col>\n      </ion-row>\n    </form>\n  </ion-card>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\login\login.html"*/
        }),
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Injectable"])(),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__ionic_native_file__["a" /* File */],
...
var UpdateProfile = /** @class */ (function () {
    ...
    UpdateProfile = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-updateProfile',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\login\userProfile\updateProfile\updateProfile.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>User Details</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <ion-grid style="height: 10%">\n    <ion-row justify-content-center align-items-center style="height: 100%">\n      <h3> Update User Details : </h3>\n    </ion-row>\n  </ion-grid>\n\n\n  <div *ngIf="error" class="error-message">{{error}}</div>\n  <div col-md-12 col-lg-12 col-xl-12 padding="\'true\'" scroll="false" class="has-header margin-auto">\n    <ion-card>\n      <form class="list" #newStudentForm="ngForm" (ngSubmit)="updateUserDetails()">\n        <ion-row>\n          <ion-col>\n            <ion-list inset>\n\n              <ion-item>\n                <ion-label text-wrap>First Name : </ion-label>\n                <ion-input name="firstname" required [(ngModel)]="firstname" type="text"></ion-input>\n              </ion-item>\n\n              <ion-item>\n                <ion-label text-wrap>Last Name : </ion-label>\n                <ion-input name="lastname" required [(ngModel)]="lastname" type="text"></ion-input>\n              </ion-item>\n\n              <ion-item>\n                <ion-label text-wrap>Email ID : </ion-label>\n                <ion-input disabled="true" name="emailId" required [(ngModel)]="emailId" type="email"></ion-input>\n              </ion-item>\n\n\n              <ion-item>\n                <ion-label text-wrap>Password : </ion-label>\n                <ion-input name="password" id="password" [type]="passwordType[0]" disabled="true" required\n                  [(ngModel)]="password"></ion-input>\n                <ion-icon item-end [name]="passwordIcon[0]" class="passwordIcon" (click)=\'hideShowPassword(0)\'>\n                </ion-icon>\n              </ion-item>\n\n              <ion-item>\n                <ion-label text-wrap>Re-type Password : </ion-label>\n                <ion-input name="reTypePassword" [type]="passwordType[1]" disabled="true" required\n                  [(ngModel)]="reTypePassword"></ion-input>\n                <ion-icon item-end [name]="passwordIcon[1]" class="passwordIcon" (click)=\'hideShowPassword(1)\'>\n                </ion-icon>\n              </ion-item>\n\n              <ion-item>\n                <ion-label text-wrap>User Role : </ion-label>\n                <ion-input name="userRole" required [(ngModel)]="userRole" type="text" disabled="true"></ion-input>\n              </ion-item>\n\n              <ion-item>\n                <ion-label text-wrap>Security Question : </ion-label>\n                <ion-input name="securityQuestion" required [(ngModel)]="securityQuestion" type="text"></ion-input>\n              </ion-item>\n\n              <ion-item>\n                <ion-label text-wrap>Answer : </ion-label>\n                <ion-input name="answer" [type]="passwordType[2]" required [(ngModel)]="answer"></ion-input>\n                <ion-icon item-end [name]="passwordIcon[2]" class="passwordIcon" (click)=\'hideShowPassword(2)\'>\n                </ion-icon>\n              </ion-item>\n\n              <ion-grid style="height: 100%">\n                <ion-row justify-content-center align-items-center style="height: 100%">\n                  <button ion-button class="submit-btn" full type="submit"\n                    [disabled]="!newStudentForm.form.valid">Update\n                    User\n                  </button>\n                </ion-row>\n              </ion-grid>\n\n            </ion-list>\n          </ion-col>\n        </ion-row>\n      </form>\n    </ion-card>\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\login\userProfile\updateProfile\updateProfile.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1_ionic_angular__["h" /* NavController */],
            __WEBPACK_IMPORTED_MODULE_2__ionic_native_file__["a" /* File */],
            __WEBPACK_IMPORTED_MODULE_1_ionic_angular__["i" /* NavParams */],
...
var ViewPreSessionUnKnownWord = /** @class */ (function () {
    ...
    ViewPreSessionUnKnownWord = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-viewPreSessionUnKnownWord',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\methodSessions\flashCardTest\preeSessionResult\viewPreSessionUnknownWord\viewPreSessionUnKnownWord.html"*/'<div *ngIf="error" class="error-message">{{error}}</div>\n<ion-content padding="\'true\'" scroll="false" class="has-header">\n  <div class="ion-content">\n\n    <ion-grid style="height: 70%">\n      <h3 style="font-size: 100px;padding-top: 5%; padding-left: 18%"> {{wordDataObj.wordText}} </h3>\n    </ion-grid>\n  </div>\n  <div class="ion-content">\n    <ion-grid style="height: 30%">\n      <ion-row justify-content-center align-items-center style="height: 100%">\n        <button ion-button class="submit-btn" (click)="dismiss()">Close</button>\n      </ion-row>\n    </ion-grid>\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\methodSessions\flashCardTest\preeSessionResult\viewPreSessionUnknownWord\viewPreSessionUnKnownWord.html"*/
        }),
        __metadata("design:paramtypes", [__WEBPACK_IMPORTED_MODULE_1__ionic_native_file__["a" /* File */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["i" /* NavParams */],
            __WEBPACK_IMPORTED_MODULE_2_ionic_angular__["l" /* ViewController */]])
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_0__angular_core__ = __webpack_require__(0);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_1__angular_forms__ = __webpack_require__(46);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_2__angular_http__ = __webpack_require__(620);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_6__ionic_native_firebase__ = __webpack_require__(628);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_11__ionic_native_stripe_ngx__ = __webpack_require__(629);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_14_firebase__ = __webpack_require__(633);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_16_ng2_charts__ = __webpack_require__(752);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_17__components_AddStudent_AddStudent__ = __webpack_require__(802);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_20__components_Assessment_BeginAssessmentTest_assessmentTest__ = __webpack_require__(805);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_21__components_Assessment_viewAssessment_viewAssessment__ = __webpack_require__(806);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_22__components_Assessment_viewStudentDatasetRecordList_viewStudentDatasetRecordList__ = __webpack_require__(807);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_23__components_billingGenerator_ManageSubscription_selectSubscription_selectSubscription__ = __webpack_require__(809);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_24__components_charts_lineCharts_lineCharts__ = __webpack_require__(810);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_25__components_flashCardTest_flashCard__ = __webpack_require__(811);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_28__components_login_addAdminAccess_addAdminAccess__ = __webpack_require__(1240);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_29__components_login_addEmail_addEmailList__ = __webpack_require__(1241);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_30__components_login_addUserDetails_addUserDetails__ = __webpack_require__(1242);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_31__components_login_forgetPassword_securityCheckUP_SecurityCheckUp__ = __webpack_require__(1243);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_32__components_login_login__ = __webpack_require__(585);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_33__components_login_OrganizationRegister_organizationRegister__ = __webpack_require__(1244);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_35__components_methodSessions_flashCardTest_DIMethodSessionTest_DIFlashCardSessionTest__ = __webpack_require__(1245);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_36__components_methodSessions_flashCardTest_flashCardIntervention__ = __webpack_require__(1247);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_37__components_methodSessions_flashCardTest_preeSessionResult_preSessionResult__ = __webpack_require__(1248);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_39__components_methodSessions_flashCardTest_preSessionFlashCardTest_preSessionFlashCard__ = __webpack_require__(1249);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_40__components_methodSessions_flashCardTest_sessionSummary_sessionSummary__ = __webpack_require__(1250);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_41__components_methodSessions_preSessionAssessment_preSessionAssessmentView_preSessionAssessmentView__ = __webpack_require__(1251);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_42__components_methodSessions_sessionsList_sessionList__ = __webpack_require__(1252);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_43__components_methodSessions_viewPreSessionData_preSessionData__ = __webpack_require__(1253);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_44__components_PostAssessment_postAssessmentDashBoard_postAssessmentDashBoard__ = __webpack_require__(1254);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_45__components_PostAssessment_postAssessmentFlashCard_postAssessmentFlashCard__ = __webpack_require__(1255);
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_46__components_PostAssessment_startNewPostAssessment_startNewPostAssessment__ = __webpack_require__(590);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_54__components_viewWordList_viewWordList__ = __webpack_require__(591);
...
/* harmony import */ var __WEBPACK_IMPORTED_MODULE_8__models_studentDataSetRecord__ = __webpack_require__(808);
...
var LineChart = /** @class */ (function () {
    ...
    LineChart = __decorate([
        Object(__WEBPACK_IMPORTED_MODULE_0__angular_core__["Component"])({
            selector: 'page-lineCharts',template:/*ion-inline-start:"F:\Work\Ionic\AIAPPHtml\src\components\charts\lineCharts\lineCharts.html"*/'<ion-header>\n  <ion-navbar>\n    <button ion-button menuToggle>\n      <ion-icon name="menu"></ion-icon>\n    </button>\n    <ion-title>Line Charts</ion-title>\n  </ion-navbar>\n</ion-header>\n\n<ion-content padding>\n  <h3> Growth Charts</h3>\n  <div col-sm-12 col-md-12 col-lg-12 col-xl-12 has-header="true" padding="true" ng-controller="AppCtrl as ctrl"\n    class="margin-auto">\n    <!-- <ion-card> -->\n    <div style="width: 70%;" *ngIf="chartData.length > 0">\n      <canvas baseChart [chartType]="\'line\'" [datasets]="chartData" [labels]="chartLabels" [options]="chartOptions"\n        [colors]="myColors" [legend]="true" (chartClick)="onChartClick($event)">\n      </canvas>\n    </div>\n\n    <!-- </ion-card>     -->\n  </div>\n</ion-content>'/*ion-inline-end:"F:\Work\Ionic\AIAPPHtml\src\components\charts\lineCharts\lineCharts.html"*/
        }),
